...
function MenuEditor(idSelector, options) {
    ...
    function TButtonGroup() {
        ...
        var $btnUp = TButton({classCss: 'btn btn-secondary btn-sm btnUp btnMove', text: '<i class="fa fa-angle-up clickable"></i>'});
        var $btnDown = TButton({classCss: 'btn btn-secondary btn-sm btnDown btnMove', text: '<i class="fa fa-angle-down clickable"></i>'});
        var $btnOut = TButton({classCss: 'btn btn-secondary btn-sm btnOut btnMove', text: '<i class="fa fa-level-down clickable"></i>'});
        var $btnIn = TButton({classCss: 'btn btn-secondary btn-sm btnIn btnMove', text: '<i class="fa fa-level-up clickable"></i>'});
    ...
    this.add = function(){
        ...
        var textItem = $('<span>').addClass('txt').text(data.name);
