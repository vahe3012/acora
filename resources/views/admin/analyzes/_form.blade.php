        ...
        <div class="card card-default">
            <div class="card-body">
                    ...
                    <div class="col-md-8">
                        <div class="form-group col-9">
                            ...
                            <input type="text"
                                   ...
                                   id="title_am" name="title_am" value="{{ old('title_am') ?: (isset($analyze) ? $analyze->title_am : '') }}">
                            @error('title')
                        ...
                        <div class="form-group col-9">
                            ...
                            <input type="text"
                                   ...
                                   id="title_en" name="title_en" value="{{ old('title_en') ?: (isset($analyze) ? $analyze->title_en : '') }}">
                            @error('title')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 p-0">
                                                <media-uploader
                                                    ...
                                                    :prop-selected-attachments="{{ json_encode(old('attachment_id') ? \App\Models\Attachment::where('id', old('attachment_id'))->get() : (isset($analyze) ? [$analyze->attachment] : []))}}"
                                                ></media-uploader>
                                                @error('attachment_id')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                ...
                <div class="card-footer ml-2">
                    <button type="submit" class="btn btn-default btn-outline-success green-btn float-right" form="create-form">Պահպանել</button>
